...
@section('clientContent')
 ...
 <div class="img-fluid" >
            ...
            <div class="col-md-12">
                <table class="table table-bordered text-center">
                    <thead>
                        ...
                        @if( Session::has('cart') )
                        @foreach(Session::get('cart')->product as $rows )
                        <tr>
                            ...
                            <td style="vertical-align: middle;"><a href="#" class="btn btn-light"><i class="fas fa-times"></i></a></td>
                        </tr>
                        @endforeach
                        @endif
                    </thead>
    ...
    <div class="container col-lg-4 offset-lg-4 ml-auto mb-5">
        <div class="checkout">
            <ul>
                <li class="subtotal">Subtotal <span>$69.99</span> </li>
                <li class="cart-total">Total <span>$69.99</span> </li>
            </ul>
