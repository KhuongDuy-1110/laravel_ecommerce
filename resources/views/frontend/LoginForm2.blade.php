                ...
                <div class="col-md-7">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="col-md-12 d-flex">
                            <input type="submit" value="Log In" class="btn btn-block btn-primary border-0 p-2" style="background-color: #6C4A4A;">
                            <span class="ml-2 mr-2">or</span>
                            <input type="submit" value="Register" class="btn btn-block btn-primary border-0 p-2" style="background-color: #6C4A4A;">
                        </div>
